...
class StopThresholdTests(unittest.TestCase):
    ...
    def test_evaluate_all_moves_rewards_recent_failed_guess_collapse(self):
        engine = DaVinciDecisionEngine()
        model = BehavioralLikelihoodModel()
        full_probability_matrix = {
            "opp": {
        ...
        self.assertGreater(collapsed_moves[0]["failed_guess_slot_pressure"], 0.0)
        self.assertGreater(collapsed_moves[0]["failure_collapse_bonus"], 0.0)
        self.assertGreater(
            collapsed_moves[0]["expected_value"],
    ...
    def test_choose_best_move_surfaces_self_exposure_threshold_breakdown(self):
        engine = DaVinciDecisionEngine()
        all_moves = [
            {
                "expected_value": 0.88,
                ...
                "self_public_exposure": 0.58,
                "self_newly_drawn_exposure": 0.52,
                "self_finish_fragility": 0.31,
            },
        ]

        _, summary = engine.choose_best_move(
            all_moves,
            risk_factor=engine.calculate_risk_factor(2),
            my_hidden_count=2,
        )

        self.assertGreater(summary["decision_score_breakdown"]["self_exposure_threshold"], 0.0)
        self.assertGreater(summary["decision_score_breakdown"]["newly_drawn_threshold"], 0.0)
        self.assertGreater(summary["decision_score_breakdown"]["finish_fragility_threshold"], 0.0)
        self.assertEqual(
            summary["decision_score_breakdown"]["total_stop_threshold"],
    ...
    def test_choose_best_move_expands_low_confidence_guard_under_self_exposure(self):
        ...
        fragile_moves = [
            {
                "expected_value": 0.96,
                "immediate_expected_value": 0.96,
                "win_probability": 0.44,
                "continuation_value": 0.12,
                "continuation_likelihood": 0.54,
                "attackability_after_hit": 0.70,
                "post_hit_continue_score": 0.0,
                "post_hit_stop_score": 0.0,
                "post_hit_continue_margin": 0.0,
                ...
                "post_hit_top_k_continue_margin": 0.0,
                "post_hit_top_k_support_ratio": 0.0,
                "self_public_exposure": 0.52,
                "self_newly_drawn_exposure": 0.48,
                "self_finish_fragility": 0.14,
            },
        ]
        stable_moves = [
            {
        ...
        self.assertIsNotNone(stable_best)
        self.assertGreater(
            fragile_summary["decision_score_breakdown"]["low_confidence_guard_margin"],
            stable_summary["decision_score_breakdown"]["low_confidence_guard_margin"],
        )

    def test_choose_best_move_uses_failure_recovery_pressure(self):
        engine = DaVinciDecisionEngine()
        recovery_moves = [
            {
                "expected_value": 0.72,
                ...
                "post_hit_failure_recovery_bonus": 0.18,
                "post_hit_failed_switch_bonus": 0.08,
        ...
        recovery_best, recovery_summary = engine.choose_best_move(
            recovery_moves,
            risk_factor=engine.calculate_risk_factor(2),
            my_hidden_count=2,
        )
        ...
        self.assertIsNotNone(recovery_best)
        self.assertIsNone(stable_best)
        self.assertGreater(
            recovery_summary["decision_score_breakdown"]["failure_recovery_pressure"],
            0.0,
        )
        self.assertGreater(
            recovery_summary["continue_margin"],
    ...
    def test_choose_best_move_uses_joint_collapse_support(self):
        engine = DaVinciDecisionEngine()
        collapse_moves = [
            {
                "expected_value": 0.72,
                ...
                "post_hit_top_k_support_ratio": 1.0,
                "post_hit_top_k_expected_support_ratio": 1.0,
                "joint_collapse_signal": 0.88,
                "joint_collapse_bonus": 0.16,
                "joint_collapse_continuation_bonus": 0.06,
                "self_public_exposure": 0.06,
                "self_newly_drawn_exposure": 0.02,
                "self_finish_fragility": 0.02,
            },
        ...
        collapse_best, collapse_summary = engine.choose_best_move(
            collapse_moves,
            risk_factor=engine.calculate_risk_factor(2),
            my_hidden_count=2,
        )
        ...
        self.assertIsNotNone(collapse_best)
        self.assertIsNone(stable_best)
        self.assertGreater(
            collapse_summary["decision_score_breakdown"]["joint_collapse_support"],
            0.0,
        )
        self.assertGreater(
            collapse_summary["continue_margin"],
            stable_summary["continue_margin"],
        )
    ...
    def test_choose_best_move_uses_target_chain_support(self):
        engine = DaVinciDecisionEngine()
        chain_moves = [
            {
                "expected_value": 0.72,
                ...
                "post_hit_top_k_support_ratio": 1.0,
                "post_hit_top_k_expected_support_ratio": 1.0,
                "target_chain_signal": 0.90,
                "target_chain_bonus": 0.15,
                "target_chain_continuation_bonus": 0.05,
                "self_public_exposure": 0.06,
                "self_newly_drawn_exposure": 0.02,
                "self_finish_fragility": 0.02,
            },
        ...
        chain_best, chain_summary = engine.choose_best_move(
            chain_moves,
            risk_factor=engine.calculate_risk_factor(2),
            my_hidden_count=2,
        )
        ...
        self.assertIsNotNone(chain_best)
        self.assertIsNone(stable_best)
        self.assertGreater(
            chain_summary["decision_score_breakdown"]["target_chain_support"],
            0.0,
        )
        self.assertGreater(
            chain_summary["continue_margin"],
            stable_summary["continue_margin"],
        )

    def test_choose_best_move_uses_target_finish_chain_support(self):
        engine = DaVinciDecisionEngine()
        finish_moves = [
            {
                "expected_value": 0.72,
                ...
                "post_hit_top_k_support_ratio": 1.0,
                "post_hit_top_k_expected_support_ratio": 1.0,
                "target_finish_chain_signal": 0.92,
                "target_finish_chain_bonus": 0.18,
                "target_finish_chain_continuation_bonus": 0.06,
                "self_public_exposure": 0.06,
                "self_newly_drawn_exposure": 0.02,
                "self_finish_fragility": 0.02,
            },
        ...
        finish_best, finish_summary = engine.choose_best_move(
            finish_moves,
            risk_factor=engine.calculate_risk_factor(2),
            my_hidden_count=2,
        )
        ...
        self.assertIsNotNone(finish_best)
        self.assertIsNone(stable_best)
        self.assertGreater(
            finish_summary["decision_score_breakdown"]["target_finish_chain_support"],
            0.0,
        )
        self.assertGreater(
